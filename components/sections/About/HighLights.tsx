    ...
    return (
        <div className="flex gap-8 flex-wrap justify-center">
            {highlights.map((item, index) => (
                <div
                    key={index}
                    className="relative bg-white/10 backdrop-blur-md text-white max-w-[300px] space-y-6 rounded-lg border border-white/20 p-6 pt-12 shadow-md w-full"
                >
                    ...
                    <p className="text-justify text-sm text-gray-200">{item.desc}</p>
                </div>
