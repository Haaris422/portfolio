  ...
  return (
    <div className="p-2 lg:px-32">
      ...
      <div className="px-2 py-8 lg:p-16 space-y-4">
        ...
        <div>
            <h2 className="relative pb-8 group text-2xl font-bold text-center lg:text-left w-full">
          <span className="relative inline-block">
            Frontend Skills
            <span className="absolute -bottom-[3px] left-1/2 -translate-x-1/2 lg:left-0 lg:translate-x-0 h-1.5 bg-amber-400 rounded-full transition-all duration-300 w-full lg:w-[40%] group-hover:w-full"></span>
          </span>
        ...
        <h2 className="relative py-8 mt-4 group text-2xl font-bold text-center lg:text-left w-full">
          <span className="relative inline-block">
            Backend Skills
            <span className="absolute -bottom-[3px] left-1/2 -translate-x-1/2 lg:left-0 lg:translate-x-0 h-1.5 bg-amber-400 rounded-full transition-all duration-300 w-full lg:w-[40%] group-hover:w-full"></span>
          </span>
