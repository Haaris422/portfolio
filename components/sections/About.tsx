...
export function About() {
  ...
  return (
      <div className="py-24 px-48 flex flex-col-reverse justify-between md:flex-row md:space-x-16 items-center ">
        <div className="space-y-4 animate-slide-in min-h-[250px]">
          ...
          <div className="py-6">
            <h3 className="relative group mb-6 text-2xl font-bold text-center md:text-left w-full">
              <span className="relative inline-block">
                Skills & Expertise
                <span className="absolute -bottom-[3px] left-1/2 -translate-x-1/2 md:left-0 md:translate-x-0 h-1.5 bg-amber-400 rounded-full transition-all duration-300 w-full md:w-[40%] group-hover:w-full"></span>
              </span>
            </h3>
            <div className="flex max-w-[750px] flex-wrap gap-4 pt-6 justify-center md:justify-start">
          ...
          <div className="flex space-x-4 pt-8 justify-center md:justify-start">
...
">
        ...
        <div className="relative group animate-slide-in-opp mb-8 md:mb-0">
          ...
          <img
            className="relative rounded-2xl border-2 border-gray-800 min-h-[250px] min-w-[250px] 
